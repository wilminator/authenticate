...
if(isset($_GET['confirm']))
    {
    $result=$auth->cancel_account_reset($userid,$victimid,$context);
...
<html>
<head>
<title>Cancel Pending Account Reset</title>
</head>
<body>
<table>
  <tr><th>
    <table>
      <caption><b>Are you sure you want to cancel the reset for the account <?=$name?>?</b></caption>
      <tr>
        <td><a href="cancel_reset.php?victimid=<?=$victimid?>&confirm=YES">Yes, delete this account.</a></td>

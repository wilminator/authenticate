...
if(isset($_GET['confirm']))
    {
    $result=$auth->cancel_email_change($userid,$victimid,$context);
...
<html>
<head>
<title>Cancel Pending Email Change</title>
</head>
<body>
<table>
  <tr><th>
    <table>
      <caption><b>Are you sure you want to cancel the email change for the account <?=$name?>?</b></caption>
      <tr>
        <td><a href="cancel_email.php?victimid=<?=$victimid?>&confirm=YES">Yes, delete this account.</a></td>

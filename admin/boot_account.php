...
if(isset($_GET['confirm']))
    {
    $result=$auth->boot_account($userid,$victimid,$context);
...
<html>
<head>
<title>Boot User Account</title>
</head>
<body>
<table>
  <tr><th>
    <table>
      <caption><b>Are you sure you want to boot the account <?=$name?>?</b></caption>
      <tr>
        <td><a href="boot_account.php?victimid=<?=$victimid?>&confirm=YES">Yes, boot this account.</a></td>
        <td><a href="edit_account.php?victimid=<?=$victimid?>">Do not boot this account.</a></td>
      </tr>
    </table>
  </th></tr>
</table>
